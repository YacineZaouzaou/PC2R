    ...
    while !reset do
        ...
        for i=0 to (List.length !players)-1 do
            ...
            let player = (List.nth !players i) in 
                print_string "cumul :";
                print_float (List.nth !(player.commande) 0);
                print_string ", ";
                print_float (List.nth !(player.commande) 1);
                print_string "\n";
                flush stdout;
                    ...
                    | "CONNECT" ->
                        ...
                        if not(user_exists players username) then begin
                            ...
                            players := (List.append !players [{username=username;
                                ...
                                vect_vitesse=ref [0.0;1.0]; direction = ref 1.57; commande=ref [0.0;0.0];score=ref 0;inchan=inchan;outchan=outchan}]);        
